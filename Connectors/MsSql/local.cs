...
/// </summary>
internal class MsSqlLocal : ILocalDb
{
    // -------------------------------------------------------------------------
    ...
    public static SqlConnection GetDatabase(string dbName, bool deleteIfExists = false)
    {
        bool exist;
        return GetDatabase(dbName, deleteIfExists, out exist);
    }
    public static SqlConnection GetDatabase(string dbName, bool deleteIfExists, out bool exist)
    {
        try
        {
            exist = false;
    ...
    public static void RunScript(SqlConnection connection, string script)
    {
        var regex = new Regex(@"\r\nGO");
        var commands = regex.Split(script);
    ...
    public static void InstallScript(SqlConnection connection, string scriptPath)
    {
